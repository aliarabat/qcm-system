...
Route::middleware('auth')->group(function () {
    Route::group(['middleware' => 'checkAuth:PROFESSOR', 'prefix' => 'questions'], function () {
    ...
    //mainParts
    Route::group(['middleware' => 'checkAuth:MANAGER', 'prefix' => 'mainparts'], function () {
    ...
    //QCM
    Route::prefix('qcm', function () {
        Route::get('/creation', 'QcmController@index')->name('qcm.index');
        Route::get('/findChapitreByModule', 'QcmController@findChapitreByModule')->name('qcm.findChapitreByModule');
        Route::get('/create', 'QcmController@createQcm')->name('qcm.createQcm');
    });
    //students
