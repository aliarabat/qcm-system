            ...
            <div style="display: flex; align-items: center;">
                ...
                <form id="filiere-form" method="post" class="col s12">
                    ...
                    <div class=" col s2 offset-s5">
                        <button id="filiereSubmit" type="submit"
        ...
        <div id="module" class="col s12">
            ...
            <div style="display: flex; align-items: center;">
                <form id="module-form" method="post" class="col s12">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <select name="filiereModule" id="filiereModule">
                                ...
                                @forelse ($filieres as $filiere)
                                    <option value="{{$filiere->nom_filiere}}">{{$filiere->nom_filiere}}
                    ...
                    <div class="col s2 offset-s5">
                        <button id="moduleSubmit" type="submit"
                                class="btn waves-effect waves-light btn-flat white-text deep-orange accent3 text-accent-4">
                            Créer
                        </button>
                    </div>
            ...
            <div class="row">
                <table class="centered" id="tableModules">
                    ...
                    @forelse ($assocSemestreModule as $assoc)
                        <tr>
                            <td>{{App\Filiere::find(App\Semestre::find($assoc->semestre_id)->filiere_id)->nom_filiere}}
                                -{{App\Semestre::find($assoc->semestre_id)->libelle}}</td>
        ...
        <div id="chapitre" class="col s12">
            <div style="display: flex; align-items: center;">
                <form id="chapitre-form" method="post" class="col s12">
                    ...
                    <div class="col s2 offset-s5">
                        <button id="chapitreSubmit" type="submit"
                                class="btn waves-effect waves-light btn-flat white-text deep-orange accent3 text-accent-4">
                            Créer
                        </button>
                    </div>
